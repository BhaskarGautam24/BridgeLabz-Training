...
16-Dec-2025 (Tuesday):
Installed and set up the Java Development Kit (JDK) and Integrated Development Environment (IDE).
Understood the Java ecosystem, project structure, and basic program execution flow.
