...
public class ExamProctor {
    ...
    static Stack<Integer> navigation = new Stack<Integer>();

    static HashMap<Integer, String> ansOfStudent = new HashMap<Integer, String>();
    ...
    static void saveAnswer(int questionId, String answer) {
        ansOfStudent.put(questionId, answer);
    ...
    static int calculateScore() {
        ...
        for (int qId : ansOfStudent.keySet()) {
            if (ansOfStudent.get(qId).equals(correctAnswers[qId])) {
                score++;
            }
        }
        return score;
